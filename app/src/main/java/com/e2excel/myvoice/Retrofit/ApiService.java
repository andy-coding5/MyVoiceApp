...
import com.e2excel.myvoice.pojo.Forget_password_request.ForgetPasswordRequest;
...
import com.e2excel.myvoice.pojo.Notification_details.Notifications;
...
import com.e2excel.myvoice.pojo.resent_otp.Data;
...
import com.e2excel.myvoice.pojo.zip_details.Zip;
...
public interface ApiService {
    ...
    Call<com.e2excel.myvoice.pojo.survey_question_detail_SCQ_MCQ_RNK.QuestionDetail> getSCQ_MCQ_RNKJson(@Header("APIKEY") String APIKEY, @Header("Authorization") String Authorization, @Path("path") String path);


    //clicked questions detail  --  OTT
    @GET("mobileapp/api/v1/data/questions/get/{path}/details")
    Call<com.e2excel.myvoice.pojo.survey_question_detail_OTT.QuestionDetail> getOTTJson(@Header("APIKEY") String APIKEY, @Header("Authorization") String Authorization, @Path("path") String path);


    //clicked questions detail  --  OTN
    @GET("mobileapp/api/v1/data/questions/get/{path}/details")
    Call<com.e2excel.myvoice.pojo.survey_question_detail_OTN.QuestionDetail> getOTNJson(@Header("APIKEY") String APIKEY, @Header("Authorization") String Authorization, @Path("path") String path);


    //clicked questions detail  --  SCL
    @GET("mobileapp/api/v1/data/questions/get/{path}/details")
    Call<com.e2excel.myvoice.pojo.survey_question_detail_SCL.QuestionDetail> getSCLJson(@Header("APIKEY") String APIKEY, @Header("Authorization") String Authorization, @Path("path") String path);
